    ...
    <Container maxWidth="xl" sx={{ marginTop: "150px", marginBottom: "150px" }}>
      ...
      <Box mt={6}>
        ...
        <Typography variant="body1" mt={3}>
          This website is operated by DWise TechLabs Private Limited (“Dwise
          Tech”). Throughout the site, the terms “we”, “us” and “our” refer to
          Dwise. Dwise Tech offers this website, including all information,
        ...
        <Typography variant="body1" mt={2}>
          ...
          in with us and agree to be bound by the following terms and conditions
          (“Terms of Use”, “Terms”), including those additional terms and
        ...
        <Typography variant="body1" mt={2}>
          ...
          use any Solutions. If these Terms of Use are considered an offer,
          acceptance is expressly limited to these Terms of Use. lementum
          adipiscing aliquam suspendisse habitant id vulputate.
        </Typography>
        <Typography variant="body1" mt={2}>
      ...
      <Box mt={4}>
        ...
        <Typography variant="body1" mt={2}>
          By agreeing to these Terms of Use , you represent that you are at
          ...
          minor dependents to use this site. You may not use our Solutions for
          any illegal or unauthorized purpose nor may you, in the use of the
          Solutions, violate any laws in your jurisdiction (including but not
          ...
          the Terms will result in an immediate termination.{" "}
        </Typography>
      </Box>
      <Box mt={4}>
        <Typography variant="h5" fontWeight={600}>
        ...
        <Typography variant="body1" mt={2}>
          ...
          exploit any portion of the Solutions, use of the Solutions, or access
          to the Solutions or any contact on the website through which the
          solutions is provided, without express written permission by us. The
      ...
      <Box mt={4}>
        ...
        <Typography variant="body1" mt={2}>
          Prices for our Solutions are subject to change without notice. We
          reserve the right at any time to modify or discontinue the Solutions
          ...
          change, suspension or discontinuance of the Solutions.
        </Typography>
      </Box>
      ...
      <Box mt={4}>
        ...
        <Typography variant="body1" mt={2}>
          Certain Solutions may be available exclusively online through the
          website. We reserve the right, but are not obligated, to limit the
          sales of our Solutions to any person, geographic region or
          jurisdiction. We may exercise this right on a case-by-case basis. We
          reserve the right to limit the quantities of any Solutions hat we
          ...
          reserve the right to discontinue any Solutions at any time. Any offer
          for any Solutions made on this site is void where prohibited. We do
          not warrant that the quality of any Solutions, information, or other
          material purchased or obtained by you will meet your expectations, or
          that any errors in the Solutions will be corrected.
        </Typography>
      </Box>
      <Box mt={4}>
        <Typography variant="h5" fontWeight={600}>
      ...
      <Box mt={4}>
        ...
        <Typography variant="body1" mt={2}>
          ...
          Solutions and/or features through the website (including, the release
          of new tools and resources). Such new features and/or Solutions shall
      ...
      <Box mt={4}>
        ...
        <Typography variant="body1" mt={2}>
          Certain content, Solutions available may include materials from
      ...
      <Box mt={4}>
        ...
        <Typography variant="body1" mt={2}>
          ...
          Terms of Use . You agree that your comments will not violate any right
          ...
          malware that could in any way affect the operation of the Solutions or
      ...
      <Box mt={4}>
        <Typography variant="h5" fontWeight={600}>
          ERRORS, INACCURACIES AND OMISSIONSON
        </Typography>

        <Typography variant="body1" mt={2}>
          Occasionally there may be information on our site or in the Solutions
          ...
          Solutions or on any related website is inaccurate at any time without
          ...
          Solution or on any related website, including without limitation,
          pricing information, except as required by law. No specified update or
          refresh date applied in the Solutions or on any related website,
          should be taken to indicate that all information in the Solution or on
      ...
      <Box mt={4}>
        ...
        <Typography variant="body1" mt={2}>
          ...
          or operation of the Solution or of any related website, other
          ...
          interfere with or circumvent the security features of the Solution or
          any related website, other websites, or the Internet. We reserve the
          right to terminate your use of the Solution or any related website for
      ...
      <Box mt={4}>
        ...
        <Typography variant="body1" mt={2}>
          ...
          Solutions will be uninterrupted, timely, secure or error-free. We do
          not warrant that the results that may be obtained from the use of the
          Solution will be accurate or reliable. You agree that from time to
          time we may remove the Solution for indefinite periods of time or
          cancel the Solution at any time, without notice to you. You expressly
          agree that your use of, or inability to use, the Solution is at your
          sole risk. The Solution is provided ‘as is’ and ‘as available’ for
          ...
          case shall our directors, officers, employees, affiliates, agents,
          ...
          liability or otherwise, arising from your use of any of the Solution
          procured using the service, or for any other claim related in any way
          to your use of the Solutions, including, but not limited to, any
          errors or omissions in any content, or any loss or damage of any kind
          incurred as a result of the use of the Solutions or any content (or
      ...
      <Box mt={4}>
        ...
        <Typography variant="body1" mt={2}>
          You agree to indemnify, defend and hold harmless DWiseTech
          ...
          out of your breach of these Terms of Use or the documents they
      ...
      <Box mt={4}>
        ...
        <Typography variant="body1" mt={2}>
          ...
          all purposes. These Terms of Use are effective unless and until
          terminated by either you or us. You may terminate these Terms of Use
          at any time by notifying us that you no longer wish to use our
          Solution, or when you cease using our site. These Terms of Use and any
          policies or operating rules posted by us on this site or in respect to
          the Solution constitutes the entire agreement and understanding
          between you and us and govern your use of the Solutions, superseding
          ...
          limited to, any prior versions of the Terms of Use ). Any ambiguities
          in the interpretation of these Terms of Use shall not be construed
      ...
      <Box mt={4}>
        ...
        <Typography variant="body1" mt={2}>
          ...
          Solutions shall be governed by and construed in accordance with the
      ...
      <Box mt={4}>
        ...
        <Typography variant="body1" mt={2}>
          ...
          to our website or the Solutions following the posting of any changes
      ...
      <Box mt={4}>
        ...
        <Typography variant="h6" mt={2}>
          {" "}
          <a href="mailto:hello@kalibre.ai">hello@kalibre.ai</a>
        </Typography>
      </Box>
    </Container>
  );
